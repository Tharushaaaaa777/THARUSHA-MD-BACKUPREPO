...
cmd({
    ...
    try {
        await reply("🔍 Checking for THARUSHA-MD updates...");
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your THARUSHA-MD bot is already up-to-date!");
        }

        await reply("🚀 Updating THARUSHA-MD Bot...");
        ...
        const sourcePath = path.join(extractPath, "THARUSHA-MD-main");
