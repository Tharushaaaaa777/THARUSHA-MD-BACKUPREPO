...
async (conn, mek, m, { from, isOwner, quoted, reply }) => {
    ...
    try {
        let desc = `*❰❰ 𝐓𝐇𝐀𝐑𝐔𝐒𝐇𝐀-𝐌𝐃 𝐒𝐄𝐓𝐓𝐈𝐍𝐆 𝐋𝐈𝐒𝐓 ❱❱*

🔢 *ʀᴇᴘʟʏ ʙʟᴏᴡ ɴᴜᴍʙᴇʀ ᴄʜᴀɴɢᴇ ᴛᴏ ᴛʜᴀʀᴜꜱʜᴀ-ᴍᴅ ꜱᴇᴛᴛɪɴɢ,*
...
`;
        ...
        const vv = await conn.sendMessage(from, { image: { url: "https://files.catbox.moe/e2bbb6.jpg"}, caption: desc }, { quoted: mek });
