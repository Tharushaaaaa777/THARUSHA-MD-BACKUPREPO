...
const DeletedMedia = async (conn, mek, jid, deleteInfo) => {
    ...
    if (messageType === 'imageMessage' || messageType === 'videoMessage') {
        ...
        await conn.sendMessage(jid, { text: `> 🔰*ᴅᴇʟᴇᴛᴇᴅ ɪɴꜰᴏ -*${deleteInfo}` }, { quoted: mek });
    }
        ...
        if (update.update.message === null) {
            ...
            if (store && store.message) {
                ...
                if (isGroup) {
                    ...
                    deleteInfo = `🚫 *ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡᴀꜱ ᴅᴇʟᴇᴛᴇᴅ !!*\n\n⏰*𝐃𝐞𝐥𝐞𝐭𝐞𝐝 𝐭𝐢𝐦𝐞:* ${deleteTime}\n*🫂𝐆𝐫𝐨𝐮𝐩 𝐧𝐚𝐦𝐞:* ${groupName}\\n🚮 *𝐃𝐞𝐥𝐞𝐭𝐞𝐝 𝐛𝐲:* @${deleter}\n*👤𝐒𝐞𝐧𝐝𝐞𝐫:* @${sender}`;
